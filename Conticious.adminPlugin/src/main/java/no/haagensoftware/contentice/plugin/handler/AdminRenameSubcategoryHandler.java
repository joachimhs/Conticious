 ...
 */
public class AdminRenameSubcategoryHandler extends ContenticeHandler {
    private Logger logger = Logger.getLogger(AdminRenameSubcategoryHandler.class.getName());
